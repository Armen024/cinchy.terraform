locals {
  ...
  argocd_addon_config = {
    ...
    awsForFluentBit           = var.enable_aws_for_fluentbit ? module.aws_for_fluent_bit[0].argocd_gitops_config : null
    awsSecretsStoreCsiDriver  = var.enable_secrets_store_csi_driver_provider_aws ? module.csi_secrets_store_provider_aws[0].argocd_gitops_config : null
    secretStoreCsiDriver  = var.enable_secrets_store_csi_driver ? module.secrets_store_csi_driver[0].argocd_gitops_config : null
